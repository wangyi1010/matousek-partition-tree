...
\title{Two-Dimensional Partition Theorem: Math-Only Derivation}
\usepackage{etoolbox}
\makeatletter
...
\hypertarget{two-dimensional-partition-theorem-math-only-derivation}{%
\section{Two-Dimensional Partition Theorem: Math-Only
Derivation}\label{two-dimensional-partition-theorem-math-only-derivation}}
