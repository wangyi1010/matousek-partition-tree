"""Practical kd-style 2D partition tree: exact halfplane counting, float
arithmetic, no adversarial worst-case guarantee — the industrial
counterpart to the verified proof-skeleton in core.py."""
